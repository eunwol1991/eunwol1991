...
Usage:
    python3 epub_converter.py input.txt -o output_dir -t "Book Title" -a "Author"
"""
...
def main():
    ...
    parser.add_argument("-t", "--title", help="Book title (default: file name)")
    parser.add_argument("-a", "--author", default="", help="Author name")
    args = parser.parse_args()

    convert_txt_to_epub(args.input_file, args.output, args.title, args.author)
